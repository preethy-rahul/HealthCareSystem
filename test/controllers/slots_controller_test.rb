...
class SlotsControllerTest < ActionController::TestCase
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post :create, slot: { duration: @slot.duration, end_time: @slot.end_time, start_time: @slot.start_time }
    end
  ...
  test "should update slot" do
    patch :update, id: @slot, slot: { duration: @slot.duration, end_time: @slot.end_time, start_time: @slot.start_time }
    assert_redirected_to slot_path(assigns(:slot))
  end
